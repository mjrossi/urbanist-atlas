...
export function About() {
  ...
  useEffect(() => {
    ...
    summaries.forEach((s) => {
      s.addEventListener('click', preventToggleOnDesktop);
    });
  ...
  return (
    <>
      ...
      <div className="lede mt-48">
        ...
        <h1>
          A directory of <span className="accent">the people</span> doing the work.
        </h1>
        <p className="deck">
          The Urbanist Atlas indexes local and regional advocacy organizations working on
          transit and safe streets across the United States and Canada. Searchable by
          postal code. Curated, not scraped.
        </p>
      </div>
      ...
      <div className="spread">
        <main className="prose">
          ...
          <div className="section-kicker" id="mission">
            § I — Mission
          </div>
          <h2>Why this exists.</h2>
          <div className="h2-rule" />
          <p className="lead drop">
            The Urbanist Atlas exists for a narrow reason: when someone moves to a new
            city — or wakes up one morning angry about a dangerous intersection three
            blocks from home — they should be able to find the people already organizing
            for better streets and better transit nearby, in under a minute.
          </p>
          ...
          <details className="method-section" open>
            ...
            <p>
              Every entry passes through an editor before it gets in. No scraper, no
              algorithm picking favorites — just the criteria below, applied case by case,
              as the time and the leads turn up.
            </p>
            <h3>What gets in.</h3>
            <div className="criteria">
              ...
              <div className="row">
                ...
                <p className="def">
                  Visible public-facing work: campaigns, hearings, testimony, organizing.
                  Not just a mailing list or a 990 on file.
                </p>
                <span className="verdict yes">Required</span>
              </div>
              <div className="row">
                ...
                <p className="def">
                  Transit advocacy or safe-streets advocacy. The two scopes the Atlas
                  exists to index.
                </p>
                <span className="verdict yes">Required</span>
              </div>
              <div className="row">
                ...
                <p className="def">
                  DOTs, transit boards, and their subsidiaries are out of scope — even
                  when staffers are doing the right thing.
                </p>
              ...
              <div className="row">
                ...
                <p className="def">
                  Even pro-bono and B-Corp consultancies. The Atlas is for organizations
                  whose primary product is advocacy, not consulting.
                </p>
                <span className="verdict no">Excluded</span>
              </div>
              <div className="row">
                ...
                <p className="def">
                  A neighboring movement with overlapping priorities, but a tighter scope
                  keeps local search useful here.
                </p>
                <span className="verdict no">Excluded</span>
              </div>
            </div>
          ...
          <details className="method-section">
            ...
            <p>
              The Atlas is an independent reference work. It isn&rsquo;t affiliated with,
              endorsed by, or representing any of the organizations listed here. Entries
              draw on public sources and editorial judgment, and they go stale: a site
              lapses, a coalition reorganizes, a chapter folds.
            </p>
            <p>
              If you spot a broken link, an outdated description, an organization that no
              longer exists, or a listing that misrepresents the work of the people it
              indexes, <Link to="/submit">file a correction at the submissions desk</Link>
              . Corrections are read and applied by the same editor who maintains the
              directory.
            </p>
          </details>
          ...
          <details className="method-section">
            ...
            <p>
              The Atlas runs on a small Go service. Every endpoint and response shape
              lives in the OpenAPI document at{' '}
              <a href={openapiUrl}>
              ...
              <Link to="/colophon">colophon</Link> for the full data-source and licensing
              picture.
            </p>
            <p>
              During Phase 1 the API sits behind a shared-secret gate while we shake out
              schema and query bugs. The Phase 2 program will open self-serve free keys.
              If you&rsquo;d like an early key before Phase 2 — to build a directory
          ...
          <details className="method-section">
            ...
            <p>
              Above all, this directory rests on the work of the organizations it indexes
              — the volunteers, organizers, and staff who show up to their city&rsquo;s
              transportation meetings, week after week, and patiently argue for better.
              Postal-code geography comes from the{' '}
              <a href="https://www.census.gov">U.S. Census Bureau</a> (ZCTAs + the HUD
              USPS ZIP-to-County crosswalk) and{' '}
              <a href="https://www.statcan.gc.ca">Statistics Canada</a>&rsquo;s boundary
              files, both public-domain or open-licensed.
            </p>
          </details>
        </main>
        ...
        <aside className="rail">
          ...
          <div className="rail-block">
            ...
            <p className="mb-0">
              ...
              , a record of systems, movement, and the transition from bits to bricks.
            </p>
          </div>
          <div className="rail-block muted">
            <div className="rail-kicker">Colophon</div>
            <p className="text-sm">
              Set in <em>Fraunces</em> &amp; <em>Source Serif 4</em> for display and body,{' '}
              <em>Inter</em> for captions, <em>JetBrains Mono</em> for URLs and code.
            </p>
            <p className="text-sm mb-0">
              See the <Link to="/colophon">full colophon</Link> for sources, stack, and
              licensing.
            </p>
          </div>
        </aside>
