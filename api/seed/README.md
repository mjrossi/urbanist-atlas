...
| `regions_us_multistate.toml`        | TOML            | 3 rows (US)                   | Hand-curated multi-state advocacy regions + transit federations (nyc-tristate, chicagoland-multistate, rta-service-area). |
