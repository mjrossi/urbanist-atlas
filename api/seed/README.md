...
| `postal_codes_<cc>.csv`             | CSV (3 columns) | ~34k US, ~1.6k CA, ~7 PT      | Generated by the etl subcommand from Census ZCTA crosswalks (US) and StatsCan FSA boundary + a coarse FSA-prefix→CMA hand-mapping (CA). Smallest-anchor algorithm per the design spec. |
